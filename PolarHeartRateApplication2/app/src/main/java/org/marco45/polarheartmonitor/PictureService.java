...
import org.marco45.polarheartmonitor.onPictureCapturedListener.*;
import java.io.File;
...
public class PictureService {
    ...
    public void startCapturing(final MainActivity activity,
                               final MainActivity capturedListener) {
        this.picturesTaken = new TreeMap<>();
        this.context = (Activity)activity;
        this.manager = (CameraManager) context.getSystemService(Context.CAMERA_SERVICE);
        this.windowManager = context.getWindowManager();
        this.capturedListener = (onPictureCapturedListener)capturedListener;
...
//          final File file = new File("/Internal storage/" + this.cameraDevice.getId() + "_pic.jpg");
